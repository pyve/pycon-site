...
SECRET_KEY = 'vnwvk-vi6m9s4)r4g=23#*a0c(+ehbp9m!i4pd_i^z=3ct395s'
...
ROOT_URLCONF = 'pyconve.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'pyconve.wsgi.application'
