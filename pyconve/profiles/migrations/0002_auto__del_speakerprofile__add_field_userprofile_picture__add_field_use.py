...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_userprofile', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.about'
        db.add_column('profiles_userprofile', 'about',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('profiles_userprofile', 'picture')

        # Deleting field 'UserProfile.about'
        db.delete_column('profiles_userprofile', 'about')
