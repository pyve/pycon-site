...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profiles_sponsor', 'website', self.gf('django.db.models.fields.URLField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'Sponsor.website'
        db.alter_column('profiles_sponsor', 'website', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
